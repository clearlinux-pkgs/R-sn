...
Version  : 1.5.4
Release  : 23
URL      : https://cran.r-project.org/src/contrib/sn_1.5-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sn_1.5-4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557935321
