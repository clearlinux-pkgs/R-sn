...
Version  : 1.6.0
Release  : 29
URL      : https://cran.r-project.org/src/contrib/sn_1.6-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sn_1.6-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585696848
